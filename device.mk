...
# OTA FILES
PRODUCT_COPY_FILES += \
        $(DEVICE_FOLDER)/OTA/kernel.ota.prop:system/kernel.ota.prop \
	$(DEVICE_FOLDER)/OTA/com.otaudater.feature.xml:system/etc/permissions/com.otaudater.feature.xml \
	$(DEVICE_FOLDER)/OTA/kernel.ota.prop:system/rom.ota.prop 
# Sensors
PRODUCT_PACKAGES += \
	sensors.tuna
